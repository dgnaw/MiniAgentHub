  ...
  return (
    <div className="w-80 bg-white dark:bg-[#0d0d0d] border-r border-gray-200 dark:border-gray-800 h-screen flex flex-col text-gray-900 dark:text-white">
      <div className="p-6 flex-1">
        <h2 className="text-xl font-bold mb-8 text-gray-900 dark:text-white tracking-wide">Agent Hub</h2>
        ...
        <nav className="space-y-1">
          ...
          {sessions.length > 0 && (
            <div className="mt-4 border-t border-gray-100 dark:border-gray-800/60 pt-4">
              <div className="pb-2 px-4 text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">
                {t('sidebar.history')}
              </div>
