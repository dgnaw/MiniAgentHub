...
const sendWelcomeEmail = async (toEmail, fullName, rawPassword) => {
    ...
    const mailOptions = {
        ...
        to: toEmail,
        subject: 'Welcome to Agent Hub - Your Login Credentials',
        html: `
            ...
            <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border-radius: 12px; overflow: hidden; border: 1px solid #2a2a2a; margin: 0 auto;">
                ...
                <tr>
                    <td style="padding: 40px 30px;">
                        <p style="color: #6da3d4; font-size: 10px; font-weight: 700; letter-spacing: 2px; margin: 0 0 12px 0;">ONBOARDING CONFIRMED</p>
                        <h2 style="color: #ffffff; font-size: 22px; margin: 0 0 15px 0; font-weight: 600;">Your Agent Hub account is ready</h2>
                        <p style="color: #9ca3af; font-size: 14px; line-height: 1.6; margin: 0 0 35px 0;">
                            Hello <strong>${fullName}</strong>,<br><br>
                            Your registration is complete. Please use the temporary credentials below to access your new workspace for the first time.
                        </p>
                        ...
                        <div style="background-color: #222222; border: 1px solid #333333; border-radius: 10px; padding: 25px;">
                            ...
                            <div style="margin-bottom: 25px; display: flex; align-items: center;">
                                <div>
                                    <h3 style="color: #ffffff; font-size: 15px; margin: 0 0 5px 0;">🔑 Security Credentials</h3>
                                    <p style="color: #9ca3af; font-size: 12px; margin: 0;">Please change your password after logging in.</p>
                                </div>
                            </div>

                            <div style="margin-bottom: 20px;">
                                <p style="color: #9ca3af; font-size: 11px; font-weight: 700; letter-spacing: 1.5px; margin: 0 0 8px 0;">LOGIN EMAIL</p>
                            ...
                            <div>
                                <p style="color: #9ca3af; font-size: 11px; font-weight: 700; letter-spacing: 1.5px; margin: 0 0 8px 0;">TEMPORARY PASSWORD</p>
                        ...
                        <a href="http://localhost:5173/login" style="display: block; width: 100%; text-align: center; background-color: #006ecf; color: #ffffff; text-decoration: none; padding: 16px 0; border-radius: 8px; font-weight: 600; margin-top: 35px; font-size: 15px;">
                            Log in to Dashboard &rarr;
                        </a>

                        <p style="text-align: center; color: #9ca3af; font-size: 13px; margin-top: 30px;">
                            If you have any questions, feel free to contact the Agent Hub support team.
                        </p>
                    </td>
                </tr>
                    ...
                    <td style="padding: 0 30px 40px 30px; text-align: center;">
                        <div style="border-top: 1px solid #2a2a2a; padding-top: 30px;">
                            <p style="color: #9ca3af; font-size: 12px; margin: 0 0 20px 0;">
                                ...
                                <a href="#" style="color: #9ca3af; text-decoration: none; margin: 0 12px;">Help Center</a>
                            </p>
...
const sendResetPasswordEmail = async (toEmail, fullName, rawPassword) => {

    const mailOptions = {
        from: `"Agent Hub Admin" <${process.env.EMAIL_USER}>`,
        to: toEmail,
        subject: 'Agent Hub - Password Reset',
        html: `
        <div style="background-color: #111111; padding: 40px 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
            <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border-radius: 12px; overflow: hidden; border: 1px solid #2a2a2a; margin: 0 auto;">
                ...
                <tr>
                    <td style="padding: 40px 30px;">
                        <p style="color: #6da3d4; font-size: 10px; font-weight: 700; letter-spacing: 2px; margin: 0 0 12px 0;">PASSWORD RESET</p>
                        <h2 style="color: #ffffff; font-size: 22px; margin: 0 0 15px 0; font-weight: 600;">Your new temporary password</h2>
                        <p style="color: #9ca3af; font-size: 14px; line-height: 1.6; margin: 0 0 35px 0;">
                            Hello <strong>${fullName}</strong>,<br><br>
                            We received a request to reset the password for your Agent Hub account. Please use the temporary credentials below to log in. You will be asked to create a new, secure password immediately after logging in.
                        </p>
                        ...
                        <div style="background-color: #222222; border: 1px solid #333333; border-radius: 10px; padding: 25px;">
                            ...
                            <div style="margin-bottom: 25px; display: flex; align-items: center;">
                                <div>
                                    <h3 style="color: #ffffff; font-size: 15px; margin: 0 0 5px 0;">🔑 Security Credentials</h3>
                                    <p style="color: #9ca3af; font-size: 12px; margin: 0;">Please change your password immediately after logging in.</p>
                                </div>
                            </div>
